...
const JobDescription = (props: { active: number }) => {
  const { active } = props;
  return (
    <div className="flex flex-col items-center">
      <div className="bg-white w-[87.3%] pt-[40px] px-6 rounded-md ">
        ...
        <div>
          <h2 className="text-[20px] leading-[24.8px] font-bold mb-[28px]">
            Requirements
          </h2>
      ...
      <div className="bg-white flex justify-center p-6 mt-16 rounded-md">
